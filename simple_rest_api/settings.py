...
SECRET_KEY = 'k_pbr6ip=r8zbh=ojhj73*t=woyve__19=gttq6o+yjpn$ccz1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'simple_rest_api', 'templates'),
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'simple_rest_api', 'static'),
]
